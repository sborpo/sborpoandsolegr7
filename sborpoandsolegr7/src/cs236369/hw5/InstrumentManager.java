...
public class InstrumentManager {
	...
	public static void updateInstrument(int id,String pass,String group,String permission,String name,String phone,String address,Blob stream,UserType type) throws SQLException, InstrumentNotExists
	{
		...
		conn.setAutoCommit(false);
		 PreparedStatement instrumentExists= Instrument.getDetails(conn, id);
		 set= instrumentExists.executeQuery();
		 if (!set.next())
		 {
			throw new InstrumentNotExists();
		 }
		 PreparedStatement statementInstruments= inst.setUpdateInstDet(conn);
