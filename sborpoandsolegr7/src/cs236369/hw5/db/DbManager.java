...
public class DbManager {
	...
	public static void  constructTables() throws SQLException
	{
		...
		String reservations= "CREATE TABLE IF NOT EXISTS `instruments` ( `id` bigint(20) NOT NULL, `type` varchar(30) NOT NULL, `permission` int(11) NOT NULL, `timeslot` int(11) NOT NULL, `description` text NOT NULL, PRIMARY KEY (`id`), KEY `Permission` (`permission`),KEY `Type` (`type`),KEY `Location` (`location`)) ENGINE=InnoDB DEFAULT CHARSET=utf8;";
